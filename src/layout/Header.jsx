...
// 1. DATA: Defined outside the component (Static data)
const links = [
  { name: "Home", to: "/" },
  { name: "About", to: "/about" },
...
// 2. SUB-COMPONENT: Defined outside the main component
const LinkList = () => {
  return (
    <>
      {links.map((link) => (
...
const Header = () => {
  ...
  return (
    // Added 'drawer-end' to slide from Right to Left
    <div className="drawer drawer-end z-50 ">
      <input id="my-drawer-2" type="checkbox" className="drawer-toggle" />

      {/* Navbar UI (Always Visible) */}
        ...
        <div className="navbar w-full sticky top-0 bg-[var(--theme-bg)]/90 backdrop-blur-md border-b border-[var(--theme-border)] text-[var(--theme-text-main)] transition-colors duration-300">
          ...
          <div className="flex-none lg:hidden">
            <label
              ...
              className="btn btn-square btn-ghost text-[var(--brand-primary)]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      {/* Sidebar Content (Hidden by default, slides in from RIGHT) */}
